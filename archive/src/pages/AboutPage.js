...
const AboutPage = () => {
    return (
        <div className = "page-content">
            ...
            <p>
                I am currently studying Mathematics and Physics at a random Canadian university. Previously I worked at IBM and studied Computer Science at another random 
                Canadian University.
            </p>
